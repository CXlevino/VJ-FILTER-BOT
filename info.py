...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://artoflvlv_db_user:<hhhHEIJLOGM>@cluster0.9kwfyz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "levinostore")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'levinostore')
